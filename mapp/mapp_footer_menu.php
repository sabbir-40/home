<div id="chat_footer_mapp" style="display: none; position: absolute; z-Index: 110; width: 95%; bottom: 0px; -webkit-text-size-adjust: 100%;">
		<table cellspacing=0 cellpadding=0 border=0 width="100%">
		<tr>
			<td width="100%">
				<div style="background: url( ../pics/glass/glass_grey.png ) repeat-x #C2CDD2; border-top: 1px solid #9AA3A7; border-right: 1px solid #9AA3A7; padding: 6px; height: 36px; border-top-right-radius: 10px 10px;">
					<table cellspacing=0 cellpadding=0 border=0 width="100%">
					<tr>
						<td width="50%">
							<table cellspacing=0 cellpadding=0 border=0>
							<tr>
								<td><span style="cursor: pointer;" onClick="toggle_mapp_menu_prefs(1);toggle_extra( 'mapp_chats', '', '', 'Chat Sessions' );clear_sound('new_request');"><img src="../mapp/pics/menu_chats.png?<?php echo $VERSION ?>" width="36" height="36" border="0" alt="" class="round" style="border: 1px solid #939B9F;" id="mapp_icon_chats"></span></td>
...
<div id="div_menu_prefs" style="display: none; position: absolute; bottom: 0px; right: 0px; width: 200px; height: 330px; background: url( ../pics/glass/glass_grey.png ) repeat-x #61696D; border-top-left-radius: 10px 10px; z-Index: 106;">
	<div class="menu_mapp_pref" onClick="toggle_mapp_menu_prefs(1);toggle_extra( 'mapp_trans', '', '', 'Transcripts' );" style="border-top-left-radius: 10px 10px;">Transcripts</div>
	<?php if ( $opinfo["op2op"] ): ?>
	<div class="menu_mapp_pref" onClick="toggle_mapp_menu_prefs(1);toggle_extra( 'mapp_operators', '', '', 'Operators' );">Operators</div>
	<div class="menu_mapp_pref" onClick="toggle_mapp_menu_prefs(1);toggle_extra( 'mapp_message_board', '', '', 'Message Board' );">Message Board</div>
	<?php endif ; ?>
...
<span id="div_mapp_chat_bubble_red" style="display: none; position: absolute; bottom: 22px; left: 0px; padding: 10px; cursor: pointer; z-Index: 111;" onClick="toggle_mapp_menu_prefs(1);toggle_extra( 'mapp_chats', '', '', 'Chat Sessions' );"><img src="../mapp/pics/chat_bubble.png" width="32" height="32" border="0" alt=""></span>